...
int main(void) {
    ...
    root = DefaultRootWindow(disp);
        XGrabKey(disp, XKeysymToKeycode(disp, XK_q), Mod4Mask,
                DefaultRootWindow(disp), True, GrabModeAsync, GrabModeAsync);
        XGrabKey(disp, XKeysymToKeycode(disp, XK_w), Mod4Mask,
                DefaultRootWindow(disp), True, GrabModeAsync, GrabModeAsync);
        XGrabKey(disp, XKeysymToKeycode(disp, XK_e), Mod4Mask,
                DefaultRootWindow(disp), True, GrabModeAsync, GrabModeAsync);
        XGrabKey(disp, XKeysymToKeycode(disp, XK_r), Mod4Mask,
                DefaultRootWindow(disp), True, GrabModeAsync, GrabModeAsync);
        XGrabKey(disp, XKeysymToKeycode(disp, XK_t), Mod4Mask,
                DefaultRootWindow(disp), True, GrabModeAsync, GrabModeAsync);
        XGrabKey(disp, XKeysymToKeycode(disp, XK_a), Mod4Mask,
                DefaultRootWindow(disp), True, GrabModeAsync, GrabModeAsync);
        XGrabKey(disp, XKeysymToKeycode(disp, XK_s), Mod4Mask,
                DefaultRootWindow(disp), True, GrabModeAsync, GrabModeAsync);
        XGrabKey(disp, XKeysymToKeycode(disp, XK_z), Mod4Mask,
                DefaultRootWindow(disp), True, GrabModeAsync, GrabModeAsync);
